...
<div class="container">
  ...
  <!-- end .sidebar1 --></div>
   ...
   <h1>Cyberpunk</h1>
	   ...
	   <source src="Resources/Videos/Cyberpunk.mp4" type="video/mp4">
	   </video>
	   <h1>Meta Vita</h1>
	   <video width="640" height="480" controls>
	   <source src="Resources/Videos/Meta Vita.mp4" type="video/mp4"/>
	   </video>
	   <h1>Crown</h1>
	   <video width="640" height="480" controls>
	   <source src="Resources/Videos/Crowner.mp4" type="video/mp4"/>
	   </video>   
	   <!-- end .content --></div>
  <div class="footer">
    <!-- end .footer --></div>
